        ...
        var freeTransform = function(subject, options, callback) {
            ...
            ft.showHandles = function() {
                ...
                draggables.map(function(draggable) {
                    ...
                    var _dragMove = function(dx, dy) {
                        ...
                        ft.attrs.translate.x = ft.o.translate.x + tdx;
                        ft.attrs.translate.y = ft.o.translate.y + tdy;
                    ...
                    var _dragEnd = function() {
                        $('#svgout').trigger('dragEnd', [ft]); // added by kim: for image position when dragged on other element.
            ...
            */
            ...
            function getPaperSize() {
                ...
                if(isFirefox)
                {
                    size = { x: paper.node.clientWidth || paper.node.parentElement.clientWidth, y: paper.node.clientHeight || paper.node.parentElement.clientHeight}
                }
                else
                {
                    size = { x: parseInt(paper.node.clientWidth), y: parseInt(paper.node.clientHeight) }
                }
